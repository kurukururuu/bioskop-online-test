<template>
  <div class="flex flex-col desktop:rounded-2xl desktop:w-96 bg-blue-1 p-8 mobile:p-4">
    <div class="text-xl font-bold text-white mb-8">Ubah Tanggal Lahir</div>

    <form @submit.prevent="actionEdit">
      <BaseInput v-model="form.dob" required label="Tanggal Lahir" name="birthdate" type="date" class="desktop:mb-12 mobile:mb-12 w-full" />
