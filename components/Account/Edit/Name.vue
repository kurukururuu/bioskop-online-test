<template>
  <div class="flex flex-col desktop:rounded-2xl desktop:w-96 bg-blue-1 p-8 mobile:p-4">
    <div class="text-xl font-bold text-white mb-8">Ubah Nama</div>

    <form @submit.prevent="actionEdit">
      <BaseInput v-model="form.name" required label="Nama" name="name" type="text" class="desktop:mb-12 mobile:mb-12 w-full" />
